package gstat.premade.shutthebox;

import java.io.IOException;

import gstat.util.Dice;
...
public class ShutTheBox {
	 ...
	 * numbers and use single dice. Loses often. Win Rate less than 1%. Changes
	 * tile to true if tile is used. Will set winState to -1 if no tiles can be
	 * flipped.
	 * 
	...
	/**
	 * Main method that gathers statistics on one million games
	 * 
	 * @param args
	 *            args
	 * @throws IOException
