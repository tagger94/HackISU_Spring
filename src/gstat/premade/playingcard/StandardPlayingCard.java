package gstat.premade.playingcard;

import gstat.util.Card;
...
public class StandardPlayingCard implements Card, Comparable<StandardPlayingCard> {
	...
	/**
	 * Constructs a card with the given rank and suit. Ranks are integers
	 * greater than zero. A rank of 1 is special and is considered higher than
	 * any other rank.
	 * 
	 * @param givenRank
	 *            rank for this card
	 ...
	 *            suit for this card
	 */
	public StandardPlayingCard(int givenRank, Suit givenSuit) {
		rank = givenRank;
		suit = givenSuit;
	}
	...
	/**
	 * Returns a compact String representation of this card. Ranks of 1, 11, 12,
	 * and 13 are represented using the characters A, J, Q, and K respectively,
	 * and suits are represent as characters 'c', 'd', 'h', 's'. For example the
	 * ten of diamonds is "10d" and the queen of spades is "Qs". Ranks higher
	 * than 13 are represented numerically, e.g., "42h".
	 */
	@Override
	...
	/**
	 * Orders cards by rank from highest to lowest, and within rank, by suit
	 * from highest (SPADES) to lowest (CLUBS).
	 */
	@Override
	 ...
	 * @return array of cards with the given ranks and suit CLUBS
	 */
	public static StandardPlayingCard[] createArray(Integer... cards) {
	...
	/**
	 * Creates an array of cards from a string. The string is a comma-separated
	 * list of rank and suit representations as described in
	 * <code>toString</code>. If no suit is given, the corresponding card will
	 * be clubs. If the string is not of the correct form, the method returns
	 * null.
	 * 
	 * @param cardString
	 *            comma-separated string of card representation
	 * @return array of cards, or null if the string cannot be parsed
	 */
	public static StandardPlayingCard[] createArray(String cardString) {
		Suit suit = Suit.CLUBS; // default
