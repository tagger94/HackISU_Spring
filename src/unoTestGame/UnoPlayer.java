...
/**
 * This class is a player for UNO. It is a super class for
 * any AI classes or UI classes. It holds the name of the player
 * and the hand of the player. It could be modified to handle more, 
 * such as drawing and playing cards.
 * 
 * @author Camden Voigt
 *
 */
