...
/**
 * This class is a card for the game of UNO. It tells the color and
 * number of the Uno Card. It implements the card interface to it can
 * be utilized by the hand class. 
 * 
 * @author Camden Voigt
 *
 */
...
public class UnoCard implements Card{
	...
	/**
	 * This method allows comparison of the cards number and color
	 * with the object sent to the method.
	 * 
	 * @param other
	 * 		the object to be compared to
	 * @return
	 * 		True when the cards are eqaul
	 */
	@Override
	 ...
	 * @return
	 * 		True when cards have the same color
	 */
	...
	* This method compares the number of the card and the card sent to it
	 ...
	 * 		Card to be compared to
	 * @return
	 * 		True when cards have the same number
	 */
